...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'asahi@yukilin.onmicrosoft.com',
  ...
  email: 'asahi@yukilin.onmicrosoft.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/MCYangWu/Lin',
    },
    {
      name: 'Telegram',
      link: 'https://t.me/YK_Lin',
    },
  ],
